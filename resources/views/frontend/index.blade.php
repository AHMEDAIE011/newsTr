      ...
      <div class="row">
        <div class="col-md-6 tn-left">
          <div class="row tn-slider">
            @foreach ($latest_three_postss as $post)
            <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <div class="tab-content">
            ...
            <div id="popular" class="container tab-pane fade">
              @foreach ($gretest_posts_comment  as $post)
              <div class="tn-news">
                <div class="tn-img">
                  <img src="{{ asset($post->images->first()->path) }}" />
                </div>
                <div class="tn-title">
                  <a href="{{route('frontend.post.show',$post->slug)}}" title="{{$post->title}}">{{$post->title}}  comment({{$post->comments_count}})</a>
                </div>
              </div>
            @endforeach
            </div>
